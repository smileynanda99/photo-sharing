...
<body  >
    ...
    <ul id="slide-out" class="sidenav sidenav-fixed">
        ...
        <li><a href="#!" class="active white-text" style="background-color:teal; border-radius: 10px;"><i class="fa fa-gear prefix small red-text  text-darken-1"></i> Change password</a></li>
        <li>
            <div class="divider"></div>
        </li>
    ...
    <div class="row  container main" style="margin-top: 30px;">
    <div class="card z-depth-5 " style="margin-top: 10%; background: rgba(255, 0, 0, 0.2); max-height: 100%;">
      <form action="change_pass_check.php" method="POSt">
        <div class="user-view">
                        <div class="center" >
                            <span style="font-size:xxx-large;  ">
                            <i class="material-icons small  prefix  red-text text-darken-3">build</i> Change Password
                            </span>
        ...
        <div class="row">
           <div class="input-field col s12">
             <input type="password" name="old" id="old" placeholder="Enter Old Password"  class="validate" required>
        ...
        <div class="row">
           <div class="input-field col s12">
            <input type="password" name="new" id="new" placeholder="Enter New Password"  class="validate" required>
        ...
        <div class="row">
            <div class="center ">
              <input type="submit" name="submit" value="Change" class="btn btn-large teal-text transparent hoverable  ">
            </div>
        </div>
        </div>
      </form>
