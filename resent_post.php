...
<body>
    ...
    <ul id="slide-out" class="sidenav sidenav-fixed">
        ...
        <i class="fa fa-clipboard prefix small red-text  text-darken-1"></i> Recent Posts</a></li>
        <li>
            <div class="divider"></div>
        </li>
    ...
    <div class="row main" style="margin-top: 30px;">
        ...
        <?php
        $sql1="select * from post where 1 order by post_id desc limit 12 ";
        ...
        if($res1)
        {
          ...
          { $new=setKey($info1['post_id']);  
            ...
            <div class="center card-action">
                <a href="like/like_r.php?id=<?php echo $info1['post_id'];?>"  class="tooltipped"  data-tooltip="Like">
