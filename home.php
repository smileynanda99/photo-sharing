...
<body>
            ...
            <div class="navbar-wrapper transparent">
                ...
                <ul class="right hide-on-med-and-down">
                    <li><a href="profile.php">
                        ...
                        <li>
                        <a href="#logout" class="modal-trigger">
                            <div class="chip">
    ...
    <ul id="slide-out" class="sidenav sidenav-fixed">
        ...
        <li><a href="#!"  class="active white-text" style="background-color:teal; border-radius: 10px;">
        <i class="fa fa-home prefix small red-text text-darken-1"></i> Home</a>
        </li>
        <li>
    ...
    <?php
        ...
        $sql1="select * from post  limit $start,$per_page ";
        $res1=mysqli_query($conn,$sql1);
        if(mysqli_num_rows($res1)>0)
        {
          while( $info1=mysqli_fetch_assoc($res1))
          { $new=setKey($info1['post_id']);
            $post_key=setKey($info1['id']); 
            ?>
            ...
            <div class="center card-action">
                <a href="like/like_h.php?id=<?php echo $info1['post_id'];?>&page=<?php echo $page;?>"  class="tooltipped"  data-tooltip="Like">
    ...
    <div class="row center main">
        <ul class="pagination ">
            ...
            <li <?php
             if($page==1)
             echo "class='disabled'";?> ><a href="<?php if($page==1) 
                                                        { echo "#!"; }
                                                        else
                                                        { echo "home.php?page=".($page-1); }
                                                        ?>">
            ...
            <li <?php
             if($page==$i)
             echo "class='active teal'";?> ><a href="home.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
           <?php
             }?> 
            <li <?php
             if($page==$no_of_page)
             echo "class='disabled'";?> ><a href="<?php if($page==$no_of_page) 
                                                                 { echo "#!"; }
                                                                 else
                                                                 { echo "home.php?page=".($page+1); }
                                                                 ?>">
        ...
        {
          echo "<div class='chip center red black-text' >Sorry, Something went wrong, Please Reload page </div>";
        }
        ?>
...
{   
    ...
    Please Login To get More Image</div>";
